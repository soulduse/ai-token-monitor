...
- **프라이버시 우선 설계** — 기본은 100% 오프라인. 리더보드·채팅·웹훅은 철저히 옵트인입니다.
...
이 모든 과정은 사용자의 컴퓨터 안에서 이루어집니다. 리더보드·채팅·웹훅에 옵트인하지 않는 한 앱은 **네트워크 요청을 전혀 보내지 않으며**, 옵트인하더라도 집계된 수치만 공유될 뿐 코드나 대화 내용은 절대 공유되지 않습니다.
